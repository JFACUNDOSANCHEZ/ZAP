...
const projects = [
  ...
  },
  {
    ...
    category: 'El verdadero sabor de la tradición italiana con una actitud que te dejará sin aliento.',
     descriptionParts: [
      'Con la pasión de Maxi y Negra, que llevan más de una década deleitando a los provincia con sus 12 exitosos locales gastronómicos, nace MUFA.',
      'Esta no es solo una marca, es una declaración de intenciones. MUFA fusiona la audacia de lo contemporáneo con la tradición culinaria de Italia. Su estilo es provocador, agresivo y auténtico, diseñado para quienes buscan una experiencia que va más allá de lo convencional.',
      'Cada plato de MUFA es una explosión de sabores intensos, un guiño a la esencia italiana sin dejar de lado la innovación. Es la representación de un espíritu libre y fuerte, que se refleja tanto en su cocina como en su identidad visual.',
      'MUFA: El verdadero sabor de la tradición italiana con una actitud que te dejará sin aliento.'
    ],
    mainText: 
    'Con la pasión de Maxi y Negra, que llevan más de una década deleitando a los provincia con sus 12 exitosos locales gastronómicos, nace MUFA.' +
  ...
  },
{
    ...
    descriptionParts: [
      'Nos reinventamos para seguir a la vanguardia, pero mantuvimos intactos los valores que nos caracterizan.',
    ...
    mainText: 'El rebranding de Marull Inmobiliaria fue un paso natural para una empresa que, desde hace años, ha sido un referente en la zona sur de Córdoba. Con ese cambio de imagen, buscamos reflejar no solo una estética moderna, sino también la evolución de una relación de confianza y compromiso que se construyó a lo largo de décadas con nuestros clientes. Nuestra nueva cara fue el resultado de la misma pasión y dedicación de siempre. Nos reinventamos para seguir a la vanguardia, pero mantuvimos intactos los valores que nos caracterizan. Hoy, la marca Marull es el resultado de la confianza que, generación tras generación, la gente de Córdoba nos ha otorgado. Nos enorgullece ser la inmobiliaria que combina la tradición y experiencia de siempre con una visión moderna e innovadora.',
