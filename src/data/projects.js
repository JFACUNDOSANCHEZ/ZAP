...
const projects = [
    ...
    },
    {
        ...
        descriptionParts: [ // Texto a la izquierda
            'Con la pasión de Maxi y Negra, que llevan más de una década deleitando a la provincia de Córdoba con sus 12 exitosos locales gastronómicos, nace MUFA.',
            ...
            'Su estilo es provocador, agresivo y auténtico, diseñado para quienes buscan una experiencia que va más allá de lo convencional en Córdoba.'
        ],
        mainText: '', // Vacío
    ...
    },
    {
        ...
        descriptionParts: [ // Texto a la izquierda
            ...
            'Hoy, la marca Marull es el resultado de la confianza que, generación tras generación, la gente de Córdoba nos ha otorgado.',
        ...
        descriptionBottomText: [ // Texto debajo de la imagen de paralaje
            'El rebranding de Marull Inmobiliaria fue un paso natural para una empresa que, desde hace años, ha sido un referente en la zona sur de Córdoba.',
            'Con ese cambio de imagen, buscamos reflejar no solo una estética moderna, sino también la evolución de una relación de confianza y compromiso que se construyó a lo largo de décadas con nuestros clientes.'
        ],
        gallery: [
            project43Img,
            project44Img,
